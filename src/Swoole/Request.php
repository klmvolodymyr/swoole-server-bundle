...
class Request
{
    ...
    public static function toSymfony(\Swoole\Http\Request $request): SymfonyRequest
    {
        ...
        if ($trustedProxies = $_SERVER['TRUSTED_PROXIES'] ?? false) {
            //  $symfonyRequest::setTrustedProxies(explode(',', $trustedProxies), SymfonyRequest::HEADER_X_FORWARDED ^ SymfonyRequest::HEADER_X_FORWARDED_HOST);
            $symfonyRequest::setTrustedProxies(explode(',', $trustedProxies), SymfonyRequest::HEADER_X_FORWARDED_FOR ^ SymfonyRequest::HEADER_X_FORWARDED_HOST);
        }
